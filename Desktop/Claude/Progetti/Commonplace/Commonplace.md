...
- ✅ **Blocco A — condizioni + dadi vita (campi persistenti della scheda)**: `defaultChar`
  ...
  **Verificato in-app** (spesa dado + toggle condizione persistiti; PG di test ripristinato).
  Non deployato. Non verificato a runtime: il recupero dadi vita del riposo lungo (ispezione).
- **Prossimo:** rifinitura Realtime (prova a due client/finestre) + cosmesi pannello diff.
