...
```
`export_players.py` fa tre cose, in quest'ordine logico:
...
Conseguenza pratica: quando scrivi una pagina `player_safe: true`, **metti sempre i segreti in un callout `[!segreto-dm]`**, non nel testo normale.
